...
public class StoreCustomerFacadeREST extends AbstractFacade<StoreCustomer> {
    ...
    public void create(StoreCustomer entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Long id, StoreCustomer entity) {
        super.edit(entity);
    }
    ...
    public StoreCustomer find(@PathParam("id") Long id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<StoreCustomer> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
